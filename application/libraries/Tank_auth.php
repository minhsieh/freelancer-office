...
class Tank_auth
{
	 ...
	 * @return	array
	 */
	function create_user($username, $email, $password, $fullname, $company, $role, $phone, $email_activation, $company_name)
	{
			...
			$data = array(
				...
				'last_ip'	=> $this->ci->input->ip_address()
                        ...
                        if ($company > 0 OR $company == '-') {
                            ...
                            $company_id = $this -> _create_company($company_name,$email);
                        }
