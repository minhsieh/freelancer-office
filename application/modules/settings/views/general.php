                    ...
                    <div class="tab-content tab-content-fix">
                        <div class="tab-pane fade in active" id="tab-english">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <input type="text" class="form-control" value="<?=$this->config->item('company_mobile')?>" name="company_mobile">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label"><?=lang('fax')?> </label>
                                <div class="col-lg-3">
                                    <input type="text" class="form-control" value="<?=$this->config->item('company_fax')?>" name="company_fax">
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <?php foreach($translations as $lang) : ?>
                            ...
                            <div class="form-group">
                                <label class="col-lg-3 control-label"><?=lang('zip_code')?> </label>
                                <div class="col-lg-3">
                                    <input type="text" class="form-control"  value="<?=$this->config->item('company_zip_code_'.$lang)?>" name="company_zip_code_<?=$lang?>">
                                </div>
                            </div>
                                <div class="form-group">
                                    <label class="col-lg-3 control-label"><?=lang('country')?></label>
                            ...
                            <div class="form-group">
                                <label class="col-lg-3 control-label"><?=lang('company_email')?></label>
                                <div class="col-lg-7">
                                    <input type="email" class="form-control" value="<?=$this->config->item('company_email_'.$lang)?>" name="company_email_<?=$lang?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label"><?=lang('company_phone')?></label>
                                <div class="col-lg-3">
                                    <input type="text" class="form-control" value="<?=$this->config->item('company_phone_'.$lang)?>" name="company_phone_<?=$lang?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label"><?=lang('company_phone')?> 2</label>
                                <div class="col-lg-3">
                                    <input type="text" class="form-control" value="<?=$this->config->item('company_phone_2_'.$lang)?>" name="company_phone_2_<?=$lang?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label"><?=lang('mobile_phone')?></label>
                                <div class="col-lg-3">
                                    <input type="text" class="form-control" value="<?=$this->config->item('company_mobile_'.$lang)?>" name="company_mobile_<?=$lang?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label"><?=lang('fax')?> </label>
                                <div class="col-lg-3">
                                    <input type="text" class="form-control" value="<?=$this->config->item('company_fax_'.$lang)?>" name="company_fax_<?=$lang?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label"><?=lang('company_domain')?></label>
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" value="<?=$this->config->item('company_domain_'.$lang)?>" name="company_domain_<?=$lang?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label"><?=lang('company_vat')?></label>
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" value="<?=$this->config->item('company_vat_'.$lang)?>" name="company_vat_<?=$lang?>">
                                </div>
                            </div>
                            </div>
                        <?php endforeach; ?>
