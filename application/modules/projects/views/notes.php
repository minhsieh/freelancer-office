...
<section id="content">
    ...
    <aside class="aside-md bg-white b-r" id="subNav">
      ...
      foreach ($projects as $key => $p) { 
       ...
       <div class="pull-right">
        <small class="text-muted"><strong><?=$this->applib->fo_format_currency($cur->code, $cost)?>
            </strong></small>
        </div> <br>
  ...
  <header class="panel-heading"> <i class="fa fa-pencil"></i> <?=lang('project_notes')?></header>
                         ...
                         <aside>                       
                            <section class="paper">
                                <textarea type="text" class="form-control scrollable" name="notes" placeholder="<?=lang('type_your_note_here')?>"><?=$this->user_profile->get_project_details($this->uri->segment(4),'notes')?></textarea>
                            </section>
