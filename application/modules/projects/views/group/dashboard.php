  ...
  <div class="col-lg-12">
    <section class="panel">
      <div class="panel-body">
        ...
        ?>
          <div><strong><?=lang('progress')?></strong><div class="pull-right"><strong><?=$progress?>%</strong></div></div>
        ...
        <div class="row">
          <div class="col-lg-6">
            <ul class="list-group no-radius">
              ...
              <?=Applib::get_table_field(Applib::$projects_table,array('project_id'=>$project_id),'project_title')?></span><?=lang('project_name')?></li>
              ...
              <li class="list-group-item">
                ...
                $currency = $this->applib->client_currency($client);
                ?>
          ...
          <div class="col-lg-6">
            <ul class="list-group no-radius">
              ...
              <?php 
              if ($role == '1' OR $role == '2' OR $this -> applib -> allowed_module('view_project_cost',$username)){ ?>
              <li class="list-group-item">
                <span class="pull-right">
                <strong><?=$this->applib->fo_format_currency($currency->code, $project_cost)?>
                </strong>
        <?php
                if (Applib::get_table_field(Applib::$projects_table,
                        array('project_id'=>$project_id),'fixed_rate') == 'No') { ?>
            <small class="small text-muted">
          <?=Applib::get_table_field(Applib::$projects_table,
                        array('project_id'=>$project_id),'hourly_rate')."/".lang('hour')?>
        <?php } ?>
            </small>
                </span> 
                <?=lang('project_cost')?>
